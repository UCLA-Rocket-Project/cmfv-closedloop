...
void test_pressure_validation_two_sensors_1() {
    ...
    PressureSensor ps;
    SensorStatus ss = ps.validateSensors(SensorConfig::P_MIN - 1, SensorConfig::P_MAX + 1, pressureReturned);
...
void test_pressure_validation_two_sensors_2() {
    ...
    for (int i = 1; i < SensorConfig::PAIR_DIFFERENCE_CONSECUTIVE_COUNT; i++) {
        SensorStatus ss = ps.validateSensors(SensorConfig::P_MIN, SensorConfig::P_MAX, pressureReturned);
